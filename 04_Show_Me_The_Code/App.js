...
//  - Card Container
//      - Restaurant Cards
//          -Img, Name, Rating, Cuisine, Delivery Time, Price
//Footer 
//  - Links
//  - Copyright
//  - Address 
    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className = 'logo'src = 'https://as2.ftcdn.net/v2/jpg/05/24/99/27/1000_F_524992735_KKhYaN2E502aCAb5yDyKNfbxXH5XPucA.jpg'/>
            </div>
...
const resObj = [
    {
        ...
        "analytics": {
          "context": "seo-data-fbaffcc0-5a9c-4e74-acf6-24a186aef7ed"
        },
        "cta": {
